  ...
  return (
    <div className="py-10 max-w-5xl mx-auto px-4">
      <div className="mb-10 border-b border-zinc-200 dark:border-zinc-800 pb-6 flex items-center gap-4">
        <h1 className="text-4xl font-black text-zinc-900 dark:text-white tracking-tight">Tu Pedido</h1>
        ...
        <div className="lg:w-95 shrink-0">
          <div className="bg-white dark:bg-[#111111] p-8 rounded-4xl border border-zinc-200/60 dark:border-zinc-800/60 shadow-lg sticky top-24">
            ...
            <div className="border-t border-zinc-200 dark:border-zinc-800 pt-6 mb-8 flex justify-between items-end">
              ...
              <span className="text-4xl font-black text-zinc-900 dark:text-white">${total.toLocaleString('es-CO')}</span>
            </div>
            ...
            {!user ? (
              ...
              <button 
                ...
                disabled={procesando}
                className={`w-full text-white font-bold py-4 px-6 rounded-2xl transition-all flex items-center justify-center gap-3 shadow-lg shadow-green-500/20 text-lg ${procesando ? 'bg-green-400 cursor-not-allowed scale-95' : 'bg-green-500 hover:bg-green-600 active:scale-[0.98]'}`}
              >
