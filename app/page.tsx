  ...
  return (
    <div className="py-10">
      ...
      <div className="relative text-center mb-20 bg-white dark:bg-[#111111] py-20 sm:py-28 rounded-[3rem] border border-zinc-200/60 dark:border-zinc-800/60 shadow-sm overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-indigo-50/50 to-transparent dark:from-indigo-900/10 dark:to-transparent pointer-events-none" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {categories?.map((cat) => (
          <Link href={`/categoria/${cat.slug}`} key={cat.id} className="block group">
            <div className="relative h-[24rem] rounded-3xl overflow-hidden border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm hover:shadow-2xl hover:shadow-indigo-500/20 dark:hover:shadow-indigo-500/10 hover:-translate-y-2 transition-all duration-500">
