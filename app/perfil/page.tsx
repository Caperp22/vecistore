    ...
    <div className="py-10 max-w-5xl mx-auto px-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-10 border-b border-zinc-200 dark:border-zinc-800 pb-6 gap-6">
        ...
        <button 
          ...
          className="bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-500/20 px-5 py-3 rounded-2xl font-bold transition-all active:scale-95"
        >
          Cerrar Sesión
        </button>
      </div>
