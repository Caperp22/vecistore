...
export default function Dashboard() {
  ...
  // Estado global para que los 3 componentes compartan la misma información
  ...
  return (
    <div className="w-full">
      ...
      {activeTab === 'orders' && (
        <OrdersTab pedidos={pedidos} products={products} updateOrderStatus={updateOrderStatus} />
      )}

      {activeTab === 'metrics' && (
        <MetricsTab pedidos={pedidos} />
      )}

      {activeTab === 'products' && (
        <InventoryTab products={products} setProducts={setProducts} categories={categories} />
      )}
