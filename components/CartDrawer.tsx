...
export default function CartDrawer() {
  ...
  // Bloquear el scroll de la página de fondo cuando el carrito está abierto
  useEffect(() => {
    if (isCartOpen) {
  ...
  const handleCheckout = () => {
    closeCart(); // Cerramos el panel
    router.push('/carrito'); // Enviamos al usuario a la página de pago
  };
